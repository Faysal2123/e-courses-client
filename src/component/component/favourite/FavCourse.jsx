    ...
    return (
        <div className='bg-gray-50'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4  mt-10 gap-5 md:gap-0' >
                {/* UX/UI Design */}
                <div className='flex flex-col justify-center items-center gap-4 md:p-16  p-8 border rounded-xl md:shadow-xl shadow-md hover:shadow-lg transition-all duration-300 border-none bg-white hover:bg-yellow-100'>
                    <FaPaintBrush className='text-3xl text-yellow-500' />
                    <h2 className='text-xl font-semibold text-center'>UX/UI Design</h2>
                </div>

                {/* Development */}
                <div className='flex flex-col justify-center items-center gap-4 md:p-16 border rounded-xl md:shadow-xl shadow-md hover:shadow-lg transition-all duration-300 md:-ml-16 border-none  p-8 bg-white  hover:bg-yellow-100'>
                    <FaCode className='text-3xl text-yellow-500' />
                    <h2 className='text-xl font-semibold text-center'>Development</h2>
                </div>

                {/* Digital Marketing */}
                <div className='flex flex-col justify-center items-center gap-4 md:p-16 border rounded-xl md:shadow-xl shadow-md hover:shadow-lg transition-all duration-300 border-none md:-ml-16 p-8 bg-white hover:bg-yellow-100'>
